# -*- encoding: utf-8 -*-
# stub: sass-embedded 1.83.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/sass-contrib/sass-embedded-host-ruby/issues", "documentation_uri" => "https://rubydoc.info/gems/sass-embedded/1.83.0", "funding_uri" => "https://github.com/sponsors/ntkme", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/sass-contrib/sass-embedded-host-ruby/tree/v1.83.0" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<google-protobuf>.freeze, ["~> 4.28"])
end
