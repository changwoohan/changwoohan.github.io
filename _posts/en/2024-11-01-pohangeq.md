...
related_en: /ko/2024/11/01/pohangeq/
---
...
<ol>
  <li>Many disaster studies face the limitation of not having pre-event health data on study participants. However, since all South Korean residents are covered under a single National Health Insurance system, health utilization information is available in a central database. Utilizing data provided by the National Health Insurance Service, pre- and post-earthquake health data for individuals can be indirectly assessed. If anxiety and stress-related disorders increased post-earthquake, we would expect an increase in healthcare utilization for these disorders among Pohang residents, while such an increase would not be observed in unaffected regions.</li><br>
...
* A government investigation concluded that the Pohang earthquake was induced by activities at a geothermal power plant. Consequently, Pohang residents filed for compensation for mental distress caused by the earthquake, and a court ruled that the government should provide compensation of 2,000,000–3,000,000 KRW per person.
...
##### Related Article
Information on the [[research article]](https://ehp.niehs.nih.gov/doi/epdf/10.1289/EHP10670){:target="\_blank"} is as follows:
